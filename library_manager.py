...
if st.session_state.current_view == "add":
     ...
     with st.form(key='add_book_form'):
          ...
          with col2:
               genre = st.selectbox("Genre", [
                    "Fiction", "Non-Fiction", "Science", "Technology", "Fanstasy", "Romance", "Poetry", "Self-help", "Art", "Religion", "History", "Other"
               ])
     ...
     if not st.session_state.library:
          st.markdown("<div class='warning-message'> Your library is empty. Add some boks to get started!</div>", unsafe_allow_html=True)
     else:
          cols = st.columns(2)
          for i , book in enumerate(st.session_state.library):
               with cols[i % 2]:
                    st.markdown(f"""<div class = 'book_card'>
                                <h3>{book['title']}</h3>
...
st.markdown("---")
st.markdown("Copyright @ 2025 Ismat Fatima Personal Library Manager", unsafe_allow_html=True)
